...
public class GerenciadorEnfretamentoClubes {
    ...
    private static final ArrayList<EnfretamentoClubes> listajogos = new ArrayList<>();

    public static void registraResultado(EnfretamentoClubes clube, int golsClube, EnfretamentoClubes liga,
            EnfretamentoClubes clube1, int golsClube1) {
        ...
        EnfretamentoClubes jogo = new EnfretamentoClubes(clube.getNomeClube(), clube1.getNomeClube(),
                liga.getNomeLiga(), golsClube, golsClube1);
        salvarJogo(jogo);
    }
